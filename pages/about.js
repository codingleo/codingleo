        ...
        <section className={`${aboutStyle.aboutContainer}`}>
          <div className={`${aboutStyle.container}`}>
            <section className={`${aboutStyle.aboutText}`}>
              ...
              startups (<b><a className={`${aboutStyle.link}`} target="_blank" href="https://sparkxyz.io">SparkXYZ</a></b>), and small companies like <b><a className={`${aboutStyle.link}`} target="_blank" href="https://gregmorriscards.com"></a> </b>.</p>
              <p>After 8+ years of experience, I feel more thant ready to accept good challenges.</p>
              <div>
